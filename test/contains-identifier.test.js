...
[espree, babel].forEach(({name, utils}) => {
	...
	test(`(${name}) if node is a Program`, t => {
		t.true(lib.containsIdentifier('foo', utils.program(`foo`)));

		t.false(lib.containsIdentifier('bar', utils.program(`foo`)));
	});

	test(`(${name}) if node is a MemberExpression`, t => {
	...
	test(`(${name}) if node is an expression`, t => {
	...
	test(`(${name}) if node is a complex expression`, t => {
		t.true(lib.containsIdentifier('foo', utils.statement('foo + bar')));
		t.true(lib.containsIdentifier('foo', utils.statement('foo - bar')));
		t.true(lib.containsIdentifier('foo', utils.statement('foo || bar')));
		t.true(lib.containsIdentifier('foo', utils.statement('foo && bar')));
	...
	test(`(${name}) if node is a ConditionalExpression`, t => {
	...
	test(`(${name}) if node is an IfStatement`, t => {
	...
	test(`(${name}) if node is a TemplateLiteral`, t => {
	...
	test(`(${name}) if node is in an object`, t => {
	...
	test(`(${name}) if node is a VariableDeclaration`, t => {
	...
	test(`(${name}) if node is in an assignment`, t => {
		t.true(lib.containsIdentifier('foo', utils.statement('foo = bar;')));
	...
	test(`(${name}) if node is a or in a function`, t => {
	...
	test(`(${name}) if node is a CallExpression`, t => {
		t.true(lib.containsIdentifier('foo', utils.expression(`foo(bar)`)));
	...
	test(`(${name}) if node is a NewExpression`, t => {
	...
	test(`(${name}) if node is a ForStatement`, t => {
	...
	test(`(${name}) if node is a ForInStatement`, t => {
	...
	test(`(${name}) if node is a ForOfStatement`, t => {
	...
	test(`(${name}) if node is a loop control flow statement`, t => {
	...
	test(`(${name}) if node is a WhileStatement`, t => {
	...
	test(`(${name}) if node is a DoWhileStatement`, t => {
	...
	test(`(${name}) if node is an await expression`, t => {
	...
	test(`(${name}) if node is a switch case`, t => {
	...
	test(`(${name}) if node is a or in a class`, t => {
	...
	test(`(${name}) if node is a LabeledStatement`, t => {
		t.true(lib.containsIdentifier('foo', utils.statement(`bar: foo`)));
	...
	test(`(${name}) if node is a DebuggerStatement`, t => {
		t.false(lib.containsIdentifier('foo', utils.statement(`debugger;`)));
	});

	test(`(${name}) if node is an EmptyStatement`, t => {
		t.false(lib.containsIdentifier('foo', utils.statement(`;;;`)));
	});

	test(`(${name}) if node is with import statement`, t => {
	...
	test(`(${name}) if node is in export statement`, t => {
