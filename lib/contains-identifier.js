...
function containsIdentifier(name, node) { // eslint-disable-line complexity
	...
	switch (node.type) {
		...
		case 'SwitchStatement':
			return containsIdentifier(name, node.discriminant) || someContainsIdentifier(name, node.cases);
		case 'SwitchCase':
			return containsIdentifier(name, node.test) || someContainsIdentifier(name, node.consequent);
